...
class TestProjectParser(TestCase):
    ...
    def test_set_file_date(self):
        ...
        self.assertEqual(self.project_to_parse1.file_date, '2019-05-13')

        self.complete_project_to_parse.set_file_date()
        self.assertEqual(self.complete_project_to_parse.file_date, '2019-05-14')

    def test_set_project_deadline(self):
        self.project_to_parse2.set_project_deadline()
        self.assertEqual(self.project_to_parse2.project_deadline, '2019-11-04')

        self.complete_project_to_parse.set_project_deadline()
        self.assertEqual(self.complete_project_to_parse.project_deadline, '2020-05-02')
